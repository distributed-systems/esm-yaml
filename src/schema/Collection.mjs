...
export default class Collection extends Node {
  static set maxFlowStringSingleLineLength(val) {
    this._maxFlowStringSingleLineLength = val; 
  }

  static get maxFlowStringSingleLineLength() {
    return this._maxFlowStringSingleLineLength === undefined ? 60 : this._maxFlowStringSingleLineLength;
  }
